...
class Config(object):
    ...
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "7117525430:AAF-oN-5I-cWlCWvN56vJK-c7An6RPFhe8I")
    ...
    FORCE_SUB = os.environ.get("FORCE_SUB", "ms55478") # ⚠️ Required Username without @
